...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlatformCA) DeepCopyInto(out *PlatformCA) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlatformCA.
func (in *PlatformCA) DeepCopy() *PlatformCA {
	if in == nil {
		return nil
	}
	out := new(PlatformCA)
